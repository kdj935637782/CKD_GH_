...
namespace CKD.CAD
{
    public class CadCurveReaderAttrubutes:GH_ComponentAttributes
    {
        public CadCurveReaderAttrubutes(CadCurveReader owner):base(owner)
        {
       ...
       /// private PointF UpperCenter; 
        ...
        protected override void Render(GH_Canvas canvas, Graphics graphics, GH_CanvasChannel channel)
        {
            ...
            if (flag )
            {
                ...
                if (CadCurveReaderAttrubutes.m_Icon == null)
                {
                    CadCurveReaderAttrubutes.m_Icon = CKD.Properties.Resources.cadreader;
                }
                ...
                if (zoomFadeLow > 0)
                {
                    ...
                    GH_GraphicsUtil.RenderCenteredIcon(graphics, buttonBounds, CadCurveReaderAttrubutes.m_Icon, (double)zoomFadeLow / 255.0);
        ...
        public override GH_ObjectResponse RespondToMouseUp(GH_Canvas sender, GH_CanvasMouseEvent e)
        {
            ...
            {
                CadCurveReader cadLineReader = (CadCurveReader)base.Owner;
